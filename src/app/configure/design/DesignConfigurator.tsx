...
import { saveConf as _saveConfig, SaveConfArgs } from "./Actions";
...
export const DesignConfigurator = ({
  ...
  const { mutate: saveConfig } = useMutation({
    ...
    mutationFn: async (args: SaveConfArgs) => {
  ...
  async function saveConfiguration() {
    try {
      ...
      toast({
        title: "Something went wrong",
        description: "There was an error uploading",
        variant: "destructive",
      });
    }
  }
  ...
  function base64ToBlob(base64: string, mimeType: string) {
    ...
    const byteNumber = new Array(bytesCharacters.length);
    for (let i = 0; i < bytesCharacters.length; i++) {
      byteNumber[i] = bytesCharacters.charCodeAt(i);
    }
